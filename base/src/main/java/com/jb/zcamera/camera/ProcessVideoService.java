            ...
            if (msg.what == MESSAGE_WHAT_INTENT) {
                ...
                if (fileList.size() > 0) {
                    ...
                    if (fileSaved != null) {
                        ...
                        Log.e(TAG, "broadcastVideoFile");
                        sendFinishBroadcaset(fileSaved.getAbsolutePath(), caputure);
...
//                                });
    ...
    private void sendFinishBroadcaset(String filePath, boolean capture) {
        Log.d(TAG, "sendFinishBroadcaset");
