...
public abstract class CameraController {
	...
	public interface ErrorCallback {
		void onError(int error, CameraHolder cameraHolder);
	}
	...
	abstract void setFaceDetectionListener(final FaceDetectionListener listener);
	abstract void autoFocus(final AutoFocusCallback cb);

	@TargetApi(Build.VERSION_CODES.JELLY_BEAN)
	abstract void setAutoFocusMoveCallback(final AutoFocusMoveCallback cb);

	abstract void cancelAutoFocus();
	abstract void takePicture(final PictureCallback raw, final PictureCallback jpeg, boolean shutterSound);
	...
	abstract CameraController.CameraHolder getCamera();
